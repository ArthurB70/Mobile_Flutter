...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                IconButton(
                                    ...
                                    icon: Icon(
                                      Icons.edit,
                                      color: lista_geladeira[i].status? Colors.deepOrange: Colors.yellow,
                                    ),
                                    onPressed: () {
                                      if (!lista_geladeira.isEmpty)
                                        Navigator.push(
                                ...
                                IconButton(
                                    ...
                                    icon: Icon(
                                      Icons.delete,
                                      color: lista_geladeira[i].status? Colors.red: Colors.green,
                                    ),
                                    onPressed: () {
                                      if (!lista_geladeira.isEmpty)
        ...
        floatingActionButton: FloatingActionButton(
            ...
            onPressed: () {
              setState(() {
                if(lista_geladeira[i].topico != null){
                  try{
  ...
  void _configureAndConnect() {
    manager = MQTTRepository(
        host: 'mqtt.dioty.co',
        topic: lista_geladeira[i].topico,
        identifier: 'android',
